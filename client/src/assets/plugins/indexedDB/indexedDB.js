...
export default class IndexedDB {
  ...
  get transaction() {
    return this._db.transaction(
      [this._storeName],
      this._iDBTrans.READ_WRITE || "readwrite"
    );
  }
  ...
  _getRange(start, end) {
    ...
    if (typeof end === "boolean") {
      return end
        ? this._iDBKeyRange.upperBound(start)
        : this._iDBKeyRange.lowerBound(start);
    }
    return end === start
      ? this._iDBKeyRange.only(start)
      : this._iDBKeyRange.bound(start, end);
  }
