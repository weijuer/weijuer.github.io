<template>
  <div
    :class="['banner-container', type, { 'mouse-enter': isMouseEnter }]"
    :style="{ height: height }"
    @mouseenter="enter"
    @mouseleave="leave"
  >
    ...
    <div class="banner-content">
      <transition-group tag="ul" class="banner">
        <li
          ...
          :class="['banner-item', { active: index === active }]"
          :key="index"
        >
          <slot :item="item"></slot>
        </li>
    ...
    <div class="banner-controls">
      ...
      <section class="pagination-wrapper">
        <ul class="pagination">
          <li>
            <a href="javascript:;" class="btn prev-btn" @click="prev">上一页</a>
          </li>
          <li>
            <a href="javascript:;" class="btn next-btn" @click="next">下一页</a>
          </li>
        </ul>
      </section>
      ...
      <section class="bullet-wrapper">
        <ul class="bullet">
          <li
            v-for="(item, index) of items"
            :class="['bullet-item', { active: index === active }]"
            :key="index"
          >
            <a href="javascript:;" v-text="index + 1" @click="go(index)"></a>
          </li>
        </ul>
      </section>
    </div>
...
export default class Banner extends Vue {
  @Prop({ default: [] }) private items!: Array<any>;
  @Prop({ default: "auto", type: [Number, String] }) private height: any;
  @Prop({ default: "card" }) private type!: string;
