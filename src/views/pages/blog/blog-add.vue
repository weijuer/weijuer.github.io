<template>
    <form class="form form-horizontal" role="form" autocomplete="off">
        <div class="form-body">
            ...
            <div class="form-group">
                <label class="col-3 control-label">标签</label>
                <div class="col-6">
            ...
            <div class="form-group">
                ...
                <div class="col-6">
                    <textarea name id cols="30" rows="10" v-model="blog.description"></textarea>
                </div>
            </div>

            <div class="form-group">
                <label class="col-3 control-label">内容</label>
                <div class="col-6">
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-6 offset-3">
                    <a class="btn default-btn" @click="add_blog" href="javascript:;">保存</a>
                    <a class="btn default-btn" href="javascript:;">取消</a>
                </div>
            </div>
        </div>
    </form>
